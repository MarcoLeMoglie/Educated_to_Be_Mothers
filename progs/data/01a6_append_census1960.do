...
*******************************
**# 1. 1960 Total population  
*******************************
import excel "$Data\census\1960\Census_1960.xlsx", sheet("Sheet1") cellrange(A1:C151)  firstrow  clear
*br if province =="Alava"
drop if type =="total province"
...
save "$Data\census\census_1960_step1.dta", replace

*******************************
**# 2. 1960 population by age
*******************************
import excel "$Data\census\1960\by_age\censo1960_byage.xlsx", cellrange(A1:V301) sheet("Sheet1") firstrow clear
drop if  province =="burgos" | province =="malaga" | province =="badajoz"

drop V 
replace group17=0 if missing(group17)
...
gen group8=group14+group15+group16+group17
*rename group17 non_stated
drop group12-group17
replace province = lower(province)
replace province = subinstr(province, "Á", "a",.) 
replace province = subinstr(province, "í", "i",.) 
replace province = subinstr(province, "ó", "o",.) 
...
*rename non_stated1 non_stated_male
*rename non_stated2 non_stated_total
*rename non_stated3 non_stated_female
drop id  
order prov type pop* codprov

 
/*
replace type ="full province" if type =="total province"
foreach v of varlist pop_male - pop_female {
...
rename group`v'_female popwomen_agegroup`v'_1960
rename group`v'_male popmen_agegroup`v'_1960
rename group`v'_total pop_agegroup`v'_1960
...
bysort codprov: gen popshare_agegroup`x' =pop_agegroup`x'/ pop_total if province !="burgos"
bysort codprov: gen popsharemen_agegroup`x' =popmen_agegroup`x'/ pop_male if province !="burgos" & province !="malaga" & province !="badajoz"
bysort codprov: gen popsharewomen_agegroup`x' =popwomen_agegroup`x'/ pop_female if province !="burgos" & province !="malaga" & province !="badajoz"

label variable popshare_agegroup`x' "Pop. share age gr.`x'"


rename popshare_agegroup`x' popshare_agegroup`x'_1960 
rename popsharemen_agegroup`x' popsharemen_agegroup`x'_1960 
rename popsharewomen_agegroup`x' popsharewomen_agegroup`x'_1960 
}


foreach x in women men {
label var pop`x'_agegroup1_1960 "Pop. below 5"
label var pop`x'_agegroup2_1960 "Pop. 5-14"
label var pop`x'_agegroup3_1960 "Pop. 15-24"
label var pop`x'_agegroup4_1960 "Pop. 25-34"
label var pop`x'_agegroup5_1960 "Pop. 35-44"
label var pop`x'_agegroup6_1960 "Pop. 45-54"
label var pop`x'_agegroup7_1960 "Pop. 55-64"
label var pop`x'_agegroup8_1960 "Pop. >65" 
}
label var pop_agegroup1_1960 "Pop. below 5"
label var pop_agegroup2_1960 "Pop. 5-14"
label var pop_agegroup3_1960 "Pop. 15-24"
label var pop_agegroup4_1960 "Pop. 25-34"
label var pop_agegroup5_1960 "Pop. 35-44"
label var pop_agegroup6_1960 "Pop. 45-54"
label var pop_agegroup7_1960 "Pop. 55-64"
label var pop_agegroup8_1960 "Pop. >65"
/*
rename non_stated_female non_stated_women_1960
rename non_stated_male non_stated_men_1960
rename non_stated_total non_stated_1960
label variable non_stated_women_1960 "Non-stated age"
label variable non_stated_men_1960 "Non-stated age"
label variable non_stated_1960 "Non-stated age"
*/
rename pop_total pop_1960 
rename pop_female pop_female_1960 
rename pop_male pop_male_1960 
label variable pop_1960 "Population 1960"
label variable pop_female_1960 "Female population 1960"
label variable pop_male_1960 "Male population 1960"
* Next step it is not necessary (as the current dataset contains total population, I did it just to check all is fine)

*merge 1:1 codprov type using "$Data\census\census_1960_step1.dta"
order province codprov type pop_* pop_male_* pop_female* 
replace type ="rest province" if type=="total province"
save "$Data\census\census_1960.dta",replace

erase "$Data\census\census_1960_step1.dta"

use "$Data\census\census_1960.dta", clear
...
save "$Data\census\census_1960_step1_PROVINCElevel.dta", replace
...
order province codprov type pop_* pop_male_* pop_female* 
drop type
save "$Data\census\census_1960_PROVINCElevel.dta",replace

erase "$Data\census\census_1960_step1_PROVINCElevel.dta"
