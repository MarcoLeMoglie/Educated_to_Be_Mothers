...
**# Import
************************************
import excel "$Data\depuracion\province_level\depuracion.xlsx", sheet("Sheet1") firstrow  cellrange(A1:C51) clear
...
replace codprov =15 if province == "a coruna"
...
save "$Output_data\depuracion\depuracion_province.dta", replace
