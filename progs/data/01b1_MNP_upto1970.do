use "$Data\MNP\NF\output\MNP_1930_1970_clean.dta", clear //Noemi Facchetti


drop if administrative_unit=="municipality"
...
****** correct mistakes *******
replace alive_birth = 9425 if province == "almeria" & year ==1960 & type == "province"
replace alive_birth = 6586 if province == "almeria" & year ==1960 & type == "rest of province"

replace alive_birth = 14505 if province == "pontevedra" & year ==1956 & type == "province"
replace alive_birth = 13309 if province == "pontevedra" & year ==1956 & type == "rest of province"
...
replace alive_birth=total_birth if alive_birth==.
save "$Data\MNP\NF\output\MNP_1930_1970_clean_v2.dta", replace

use "$Data\MNP\NF\output\MNP_1930_1970_clean_v2.dta",clear 
...
keep if administrative_unit=="province"
rename province_name province
replace geo_name = province if missing(geo_name)
rename administrative_unit  type
*gen id_using=_n
...
replace alive_birth=total_birth if alive_birth==.
save "$Data\MNP\NF\output\MNP_1930_1970_clean_v2_PROVINCElevel.dta", replace

use "$Data\MNP\NF\output\MNP_1930_1970_clean_v2_PROVINCElevel.dta",clear 
