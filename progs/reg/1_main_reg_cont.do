...
if `i'==1 &  "`x'"== "flag4" {
local name = "0-14"
reghdfe `x' post_sum`i' post_sum2`i' post_teachers interaction interaction2 1.post##c.sum`i'##c.teachers_pc 1.post##c.sum2`i'##c.teachers_pc, a(i.id i.year#i.codprov ) cluster(id) 
...
*egen idprovinceyear= group(codprov year)
*
reghdfe `x' b1945.year##c.sum`i'##c.teachers_pc  b1945.year##c.sum2`i'##c.teachers_pc, a(i.id i.year#i.codprov ) cluster(id) 
