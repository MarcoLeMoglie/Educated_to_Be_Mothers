...
\item At the province level, test whether places with larger treatment gaps have lower staying rates between 1970 and 1981, using the official province-of-origin totals reported in the census table as the denominator for retention.
\end{enumerate}
...
\texttt{muni\_share\_1940} & 0.608 & 0.002 \\
\bottomrule
\end{tabular}
\end{center}
